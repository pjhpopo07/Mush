...
TEST_IMAGE_PATH = 'reading_images/2313131images.jpg' 
...
SAFETY_MAPPING = {
    ...
    '붉은점박이광대버섯 X299': '✅ 식용 버섯 (EDIBLE)', 
    '영지버섯 X299': '✅ 식용 버섯 (EDIBLE)', 
    '졸각버섯 X299': '✅ 식용 버섯 (EDIBLE)', 
    '개암버섯 X299': '✅ 식용 버섯 (EDIBLE)', 
    '흰주름버섯 X299': '✅ 식용 버섯 (EDIBLE)', 
}
